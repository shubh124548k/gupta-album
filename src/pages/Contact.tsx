...
const Contact = () => {
  ...
  return (
    <Room3D>
      ...
      <section className="pt-20 md:pt-28 pb-14 md:pb-18 px-4 relative">
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          >
            ...
            <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-foreground mb-3 md:mb-4 text-3d leading-tight">
              Contact Us
            </h1>
            <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto leading-snug">
              Have questions about our platform or need assistance finding the perfect photographer? We'd love to hear from you.
            </p>
          </motion.div>
